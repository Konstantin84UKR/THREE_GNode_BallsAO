...
import { Pass, FullScreenQuad } from 'three/examples/jsm/postprocessing/Pass.js'; //'./Pass.js'
...
class SAOPass extends Pass {
	...
	overrideVisibility() {
		...
		scene.traverse( function ( object ) {
			...
			if ( object.isPoints || object.isLine || object.name == "noAO" ) object.visible = false;
	...
	restoreVisibility() {
		...
		scene.traverse( function ( object ) {
			...
			if ( object.isPoints || object.isLine || object.name == "noAO" ) object.visible = true;
